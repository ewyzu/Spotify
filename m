...
local library = {design = getgenv().design == "kali" and "kali" or "uwuware", tabs = {}, draggable = true, flags = {}, title = "Spotify Hub", open = false, popup = nil, instances = {}, connections = {}, options = {}, notifications = {}, tabSize = 0, theme = {}, foldername = "cheatx_cnfgs", fileext = ".txt"}
        ...
        function column:AddSection(title)
            ...
            function section:Init()
                ...
                self.content = library:Create("Frame", {
                    ...
                    BackgroundColor3 = Color3.fromRGB(30, 30, 30),--30 30 30
                ...
                layout.Changed:connect(function()
                    self.main.Size = UDim2.new(3, 0, 0, layout.AbsoluteContentSize.Y + 30)
                end)
...
function library:Init()
    ...
    function self:selectTab(tab)
        ...
        self.main.Size = UDim2.new(0, 30 + ((#tab.columns < 2 and 2 or #tab.columns) * 280), 0, 580)
        self.currentTab = tab
